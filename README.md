...
************************************
このリポジトリは予告なしに削除される場合がありますので、使用時は直リンクを避け、ご自身のサーバーへアップロードすることをお勧めします。また、ライセンスはMITライセンスまたは横茶横葉Bライセンスからお選び下さい。  
(注:このライセンスは「オープンソースライセンス」であり、価格体系に関するライセンスではございません。利用料は無料です。)  
横茶横葉Bライセンスを選択した場合、フッターに以下の表示をするだけでOKです。ライセンス条文まで明記する必要はございません。  
```footer.html
<footer>
