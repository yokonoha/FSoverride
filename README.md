# FSLinear Override CSS  

FSoverride -フリーでスマートな線形スタイルのスタイルシート  
...
テンプレートはそのままアジャストしてIT系のサイトや個人サイト製作のお供に、是非。  

************************************
このリポジトリは予告なしに削除される場合がありますので、使用時は直リンクを避け、ご自身のサーバーへアップロードすることをお勧めします。また、ライセンスはMITライセンスまたは横茶横葉Aライセンスからお選び下さい。  
(注:このライセンスは「オープンソースライセンス」であり、価格体系に関するライセンスではございません。利用料は無料です。)  
横茶横葉Aライセンスを選択した場合、フッターに以下の表示をするだけでOKです。ライセンス条文まで明記する必要はございません。  
```footer.html
<footer>
<p><small>このページでは<a href="https://github.com/yokonoha/FSoverride">FSoverride</a>を使用しています。</small></p>  
</footer>
```
Or you can write this in English
```footer.html
